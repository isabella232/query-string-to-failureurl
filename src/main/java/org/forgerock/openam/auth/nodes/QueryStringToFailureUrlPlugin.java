...
public class QueryStringToFailureUrlPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(QueryStringToFailureUrlPlugin.currentVersion,
				Collections.singletonList(QueryStringToFailureUrl.class));
	}
	...
	public String getPluginVersion() {
		return QueryStringToFailureUrlPlugin.currentVersion;
	}
}
